...
from firstapp.models import Contact,Product,OrderUpdate,Orders
...
'''myid=""
    for i in items:
        ...
        myid = i.order_id
        print(myid)
    status=OrderUpdate.objects.filter(order_id)
    print(status)'''
